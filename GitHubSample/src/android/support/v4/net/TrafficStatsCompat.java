...
public class TrafficStatsCompat {
    ...
    /**
     * Clear active tag used when accounting {@link java.net.Socket} traffic originating
    ...
    /**
     * Get the active tag used when accounting {@link java.net.Socket} traffic originating
    ...
    /**
     * Set active tag to use when accounting {@link java.net.Socket} traffic originating
     * from the current thread. Only one active tag per thread is supported.
     * <p>
    ...
    /**
     * Tag the given {@link java.net.Socket} with any statistics parameters active for
    ...
    /**
     * Remove any statistics parameters from the given {@link java.net.Socket}.
     */
