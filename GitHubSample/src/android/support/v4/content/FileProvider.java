 ...
 * To generate the content URI, create a new {@link java.io.File} for the file, then pass the {@link java.io.File}
 * to {@link #getUriForFile(Context, String, java.io.File) getUriForFile()}. You can send the content URI
 * returned by {@link #getUriForFile(Context, String, java.io.File) getUriForFile()} to another app in an
 ...
 * {@link #getUriForFile(Context, String, java.io.File) getUriForFile()} returns the content URI
 ...
 * {@link #getUriForFile(Context, String, java.io.File) getUriForFile()}, do one of the following:
 * <ul>
 * <li>
 *     Call the method
...
public class FileProvider extends ContentProvider {
    ...
    /**
     * Return a content URI for a given {@link java.io.File}. Specific temporary
     ...
     * @param file A {@link java.io.File} pointing to the filename for which you want a
     * <code>content</code> {@link Uri}.
     * @return A content URI for the file.
     * @throws IllegalArgumentException When the given {@link java.io.File} is outside
     ...
     * {@link #getUriForFile(Context, String, java.io.File) getUriForFile()} to get information about a file
     ...
     * {@link #getUriForFile(Context, String, java.io.File) getUriForFile()}.
     *
     ...
     * returned by {@link #getUriForFile(Context, String, java.io.File) getUriForFile()}. Notice that this
    ...
    /**
     * Strategy for mapping between {@link java.io.File} and {@link Uri}.
     * <p>
     * Strategies must be symmetric so that mapping a {@link java.io.File} to a
     * {@link Uri} and then back to a {@link java.io.File} points at the original
     * target.
     * <p>
    ...
    interface PathStrategy {
        /**
         * Return a {@link Uri} that represents the given {@link java.io.File}.
         */
        public Uri getUriForFile(File file);

        /**
         * Return a {@link java.io.File} that represents the given {@link Uri}.
         */
