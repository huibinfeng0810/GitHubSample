...
public class ActionMenuView extends IcsLinearLayout implements MenuBuilder.ItemInvoker, MenuView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mFormatItems = View.MeasureSpec.getMode(widthMeasureSpec) == View.MeasureSpec.EXACTLY;
        ...
        final int widthSize = View.MeasureSpec.getMode(widthMeasureSpec);
    ...
    static int measureChildForCells(View child, int cellSize, int cellsRemaining,
        ...
        final int childHeightSize = View.MeasureSpec.getSize(parentHeightMeasureSpec) -
                parentHeightPadding;
        ...
        if (cellsRemaining > 0) {
            final int childWidthSpec = View.MeasureSpec.makeMeasureSpec(
                    cellSize * cellsRemaining, View.MeasureSpec.AT_MOST);
        ...
        child.measure(View.MeasureSpec.makeMeasureSpec(targetWidth, View.MeasureSpec.EXACTLY),
                childHeightSpec);
        return cellsUsed;
    }
