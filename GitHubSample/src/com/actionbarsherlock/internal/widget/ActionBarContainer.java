...
import com.actionbarsherlock.internal.nineoldandroids.wiget.NineFrameLayout;
...
public class ActionBarContainer extends NineFrameLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mActionBarView.getLayoutParams();
        ...
        if (mTabContainer != null && mTabContainer.getVisibility() != GONE) {
            ...
            if (mode == View.MeasureSpec.AT_MOST) {
                final int maxHeight = View.MeasureSpec.getSize(heightMeasureSpec);
